...
LOGOUT_REDIRECT_URL = '/'
import os
SOCIAL_AUTH_GOOGLE_OAUTH2_REDIRECT_URI = 'https://travel01-08aa06096e0c.herokuapp.com/social-auth/complete/google-oauth2/'
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = os.getenv('GOOGLE_OAUTH2_CLIENT_ID')
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = os.getenv('GOOGLE_OAUTH2_CLIENT_SECRET')
SOCIAL_AUTH_LOGIN_REDIRECT_URL = 'https://travel01-08aa06096e0c.herokuapp.com/'
